...
def DirectModelEmcee_inv_disc(tOrigTilt,tOrigGPS,
                         pd0Samp,offGPSSamp,offxSamp,offySamp,xsSamp,ysSamp,dsSamp,xdSamp,ydSamp,ddSamp,
    ...
    phi = kdSamp / ksSamp * VsSamp / VdSamp * (conddSamp / condsSamp)**4
...
def DirectModelEmcee_inv_disc_diagno(tOrigTilt,tOrigGPS,
                         pd0Samp,offGPSSamp,offxSamp,offySamp,xsSamp,ysSamp,dsSamp,xdSamp,ydSamp,ddSamp,
                         VsExpSamp,VdExpSamp,ksExpSamp,kdExpSamp,pspdSamp,R3Samp,condsSamp,conddSamp,alphaSamp,
                         Xst,Yst,
                         ls,ld,mu,
    ...
    for i in range((np.max(nstation) + 1)):
        ...
        tyMod[nstation == i] = tyMod[nstation == i] + offySamp[i]*1e-6
    gpsMod = gpsMod  + offGPSSamp
    return txMod,tyMod,gpsMod,ps,pd#,dtxMod, dtyMod
