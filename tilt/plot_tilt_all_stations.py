...
for i in station_indexes.keys():
    ...
    plt.figure()
    plt.plot(t_full,east_full,t_full,north_full)
    plt.plot(t_full,(east_full**2 + north_full**2)*0.5)
    plt.ylabel(i)
#pickle.dump(station, open( "tilt_movie.pickle", "wb" ))
