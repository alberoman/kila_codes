...
magnitude1 = -(stations['UWD']['east']**2 + stations['UWD']['north']**2)**0.5
magnitude2 = -(stations['SDH']['east']**2 + stations['SDH']['north']**2)**0.5
...
for counter in np.arange(0,len(time_tilt),step):
    ...
    ax_UWD.set_ylabel('UWD [microrad]')
    ax_SDH.set_ylabel('SDH [microrad]')
    ...
    plt.savefig('movie/' + str(filename) + '.png',bbox_inches='tight',dpi = 300)
