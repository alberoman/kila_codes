...
w_station = 7 #for the all time series
h_total_station = h_station * (N_station + 2)
...
ax = fig_main.add_subplot(3,1,2)
ax.axvspan(date_caldera_start,date_caldera_end,alpha = 0.3,color = 'blueviolet')
ax.axvline(x=date_eruption,)
ax.axvline(x=date_eruption_end)
ax.plot(time_collapses,dt_stick,'o')
ax.plot(time_collapses,dt_stick)
...
ax.set_ylabel('Days between collapses',fontsize = 14 )
